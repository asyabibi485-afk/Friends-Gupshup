...
config_error = ""
if create_client is None:
    config_error = "Supabase package is not installed. Redeploy so requirements.txt is installed."
elif not _secret("SUPABASE_URL") or not (_secret("SUPABASE_KEY") or _secret("SUPABASE_PUBLISHABLE_KEY") or _secret("SUPABASE_ANON_KEY")):
    config_error = "Supabase secrets are missing. Add SUPABASE_URL and SUPABASE_KEY (or SUPABASE_PUBLISHABLE_KEY) in Streamlit Cloud Secrets."
if config_error:
